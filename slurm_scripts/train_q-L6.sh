...
--nway 6 \
--run_tag frozen \
--experiment q-L6-plaidx \
--other_args lite_query_encoder=True lite_document_encoder=False lite_num_hidden_layers=6 lite_num_attention_heads=16 lite_encoder_init=${pretrained_base} freeze_document_encoder=True shared_linear_lite=True do_normalization=True
